...
The potential interaction with our chest is detected in **ASampleInteractableActor** using the **NotifyActorBeginOverlap** and **NotifyActorEndOverlap** functions. This require to have a collision component configured to trigger overlap events with
the character:
